...
Eclipse JNoSQL as a https://jakarta.ee/specifications/data/1.0/jakarta-data-1.0[Jakarta Data] implementations supports the following list of predicate keywords on their repositories.
