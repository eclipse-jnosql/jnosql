...
class MapperDeleteTest {
    ...
    void shouldReturnErrorWhenMapperIsNull() {
        Assertions.assertThrows(NullPointerException.class, () -> template.delete((Class<Object>) null));
    }

    @Test
    @DisplayName("Should return error when entity has not id")
    void shouldReturnErrorWhenEntityHasNotId() {
        Assertions.assertThrows(MappingException.class, () -> template.delete(ErrorEntity.class));
    }
    ...
    void shouldReturnWhenTheResultWithoutUsingOrder(){
        Assertions.assertThrows(UnsupportedOperationException.class, () -> template.delete(Person.class).execute());
    ...
    void shouldReturnErrorWhenAttributeIsNotId() {
        Assertions.assertThrows(UnsupportedOperationException.class, () -> template.delete(Person.class).where("name"));
    }

    @Test
    @DisplayName("Should return error when the operator is not supported")
    void shouldReturnErrorWhenTheOperatorIsNotSupported() {
        Assertions.assertThrows(UnsupportedOperationException.class, () -> template.delete(Person.class).where("id").like("Otavio"));
        Assertions.assertThrows(UnsupportedOperationException.class, () -> template.delete(Person.class).where("id").gt("Otavio"));
        Assertions.assertThrows(UnsupportedOperationException.class, () -> template.delete(Person.class).where("id").gte("Otavio"));
        Assertions.assertThrows(UnsupportedOperationException.class, () -> template.delete(Person.class).where("id").lt("Otavio"));
    ...
    void shouldReturnErrorWhenThereIsAndOperator() {
        Assertions.assertThrows(UnsupportedOperationException.class, () -> template.delete(Person.class).where("id").eq(10).and("id"));
    }

    @Test
    @DisplayName("Should return error when there is or operator")
    void shouldReturnErrorWhenThereIsOrOperator() {
        Assertions.assertThrows(UnsupportedOperationException.class, () -> template.delete(Person.class).where("id").eq(10).or("id"));
    }
